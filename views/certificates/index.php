...
<head>
  ...
  <title>Listado de cursos y generación de certificados QR</title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <div class="float-right d-none d-sm-inline">
      Integración prevista con la validación pública de certificados.
    </div>
    <span>
      Vista preparada para integrarse con /aulavirtual/certificate/validate/(CODIGO QR). Actualmente solo HTML y CSS.
    </span>
  </footer>
