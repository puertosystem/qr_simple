...
<head>
  ...
  <title>Crear Curso - Módulo Certificados QR</title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <div class="float-right d-none d-sm-inline">
      Vistas alineadas con la base de datos qr_certificados.
    </div>
    <span>Formulario de cursos conectado a la base de datos.</span>
  </footer>
